# Original source: https://github.com/mCodingLLC/VideosSampleCode/blob/master/videos/117_hello_async/crawl.py
...
async def main(url: str) -> List[str]:
...
if __name__ == '__main__':
    asyncio.run(main("https://scottsdaleveterinaryclinic.com/"), debug=True)
